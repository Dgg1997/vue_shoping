<template>
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="userList" border stripe>
        ...
        <el-table-column label="操作" width="180px">
          <template slot-scope="scope">
            <!--修改-->
              <el-button type="primary" icon="el-icon-edit" @click="editChange(scope.row.id)" size="mini"></el-button>
            <!--删除-->
              <el-button type="danger" icon="el-icon-delete" size="mini" @click="removeUserById(scope.row.id)"></el-button>
            <!--添加-->
            <el-tooltip  effect="drak" content="分配角色" placement="top" :enterable="false">
    ...
    <el-dialog title="用户修改" :visible.sync="editDialogVisible" width="50%" @close="editDialogClose">
      <!--对话框主体-->
      <el-form :model="editFrom" :rules="editFromRules" ref="editFromRef" label-width="70px" class="demo-ruleForm">
